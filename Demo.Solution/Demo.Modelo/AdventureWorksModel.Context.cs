...
namespace Demo.Modelo
{
    ...
    public partial class AdventureWorksConnection : DbContext
    {
        public AdventureWorksConnection()
        ...
        [DbFunction("AdventureWorksConnection", "ufnGetContactInformation")]
        public virtual IQueryable<ufnGetContactInformation_Result> ufnGetContactInformation(Nullable<int> personID)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.CreateQuery<ufnGetContactInformation_Result>("[AdventureWorksConnection].[ufnGetContactInformation](@PersonID)", personIDParameter);
        }
